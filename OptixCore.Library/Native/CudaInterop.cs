...
namespace OptixCore.Library.Native
{
    ...
    internal unsafe class CudaInterop
    {
        internal static string RunTimeAPIDll = "cudart64_101.dll";
        internal const string DriverAPIDll = "nvcuda";

        [DllImport(DriverAPIDll)]
        ...
        [DllImport(DriverAPIDll,EntryPoint = "cuMemAlloc_v2")]
        ...
        [DllImport(DriverAPIDll, EntryPoint = "cuMemFree_v2")]
        public static extern CUResult cuMemFree(CUDeviceptr dptr);

        public static void CudaCall(CUResult result)
        {
